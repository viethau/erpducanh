...
public partial class QD_ThuHoiDat_Goc
{
public string Id { get; set; }= Guid.NewGuid().ToString();
[Required(ErrorMessage = "Bạn phải nhập chi nhánh")]
public string CompanyId { get; set; } = "";
[Required(ErrorMessage = "Bạn phải nhập số QĐ thu hồi đất gốc")]
public string SoQD_ThuHoiDat_Goc { get; set; } = "";
...
public partial class QD_ThuHoiDat_Goc_Log
{
public string Id { get; set; }= Guid.NewGuid().ToString();
public string CompanyId { get; set; } = "";
public string SoQD_ThuHoiDat_Goc { get; set; } = "";
