...
namespace DucAnhERP.Services
{
    public class PKKLTDanRXayRepository :IPKKLTDanRXayRepository
    {
        ...
        public async Task<List<PKKLTDanRXay>> GetAll(string groupId)
        {
            try
            {
        ...
        public async Task Update(PKKLTDanRXay TKThepDeCong, string userId)
        {
            using var context = _context.CreateDbContext();
        ...
        public async Task Insert(PKKLTDanRXay entity,string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
