...
namespace DucAnhERP.Services
{
    public class PKKLTDanRXayRepository :IPKKLTDanRXayRepository
    {
        ...
        public async Task<string> InsertLaterFlag(PKKLTDanRXay entity, int FlagLast)
        {
            string id = "";
            try
            {
        ...
        {
            var addedEntity = entityEntry.Entity as PKKLTDanRXay;
            if (addedEntity != null)
            {
        ...
        {
            var modifiedEntity = entityEntry.Entity as PKKLTDanRXay;
