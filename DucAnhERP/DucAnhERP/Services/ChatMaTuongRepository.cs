...
namespace DucAnhERP.Services
{
    public class ChatMaTuongRepository :IChatMaTuongRepository
    {
        ...
        public async Task<List<MaTuong>> GetAll(string groupId)
        {
            try
            {
        ...
        public async Task Update(MaTuong MaTuong, string userId)
        {
            using var context = _context.CreateDbContext();
        ...
        public async Task Insert(MaTuong entity, string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<string> InsertLaterFlag(MaTuong entity, int FlagLast, bool insertBefore)
        {
            string id = "";
            try
            {
