...
namespace DucAnhERP.Services
{
    public class NuocMuaRepository : INuocMuaRepository
    {
            ...
            try
            {
                ...
                var query = from MNuocMua in context.DSNuocMua
                            ...
                            select new NuocMuaModel
                            {
                                ...
                                TTTKLCKCTCH_CDThucTeThuaThieu = MNuocMua.TTTKLCKCTCH_CDThucTeThuaThieu ?? 0,
                                TTTKLCKCTCH_XDOngCongCanThem = MNuocMua.TTTKLCKCTCH_XDOngCongCanThem ?? "",
                                TTTKLCKCTCH_CDThuaThieuSauTinhKL = MNuocMua.TTTKLCKCTCH_CDThuaThieuSauTinhKL ?? 0,
                                ...
                                TTTDCongHoRanh_XacDinhOngCongCanThem = MNuocMua.TTTDCongHoRanh_XacDinhOngCongCanThem ?? "",
        ...
        public async Task Update(NuocMua mNuocMua)
        {
            using var context = _context.CreateDbContext();
        ...
        public async Task UpdateMulti(NuocMua[] mNuocMua)
        {
            using var context = _context.CreateDbContext();
