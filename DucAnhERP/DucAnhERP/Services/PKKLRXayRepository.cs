...
namespace DucAnhERP.Services
{
    ...
    public async Task<Double> GetTKLCK_SauCCByLCK(string id)
    {
            ...
            var sumTKLCK_SauCC = context.PKKLRXays.Where(x => new[] { "I.Móng", "II.Tường", "III.Mũ mố" }.Contains(x.HangMuc) &&
    ...
    public async Task<string> InsertLaterFlag(PKKLRXay entity, int FlagLast)
    {
        string id = "";
        try
        {
    ...
    {
        var addedEntity = entityEntry.Entity as PKKLRXay;
        if (addedEntity != null)
        {
    ...
    {
        var deletedEntity = entityEntry.Entity as PKKLRXay;
