...
namespace DucAnhERP.Services
{
    public class PKKLMongCHopRepository :IPKKLMongCHopRepository
    {
        ...
        {
            var addedEntity = entityEntry.Entity as PKKLMongCHop;
            if (addedEntity != null)
            {
        ...
        {
            var modifiedEntity = entityEntry.Entity as PKKLMongCHop;
        ...
        {
            var deletedEntity = entityEntry.Entity as PKKLMongCHop;
