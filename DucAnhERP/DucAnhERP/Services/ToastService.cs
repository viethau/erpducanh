...
namespace DucAnhERP.Services
{
    public class ToastService
    {
        ...
        public void ShowToast(string title, string message, string cssClass = "toast-info", string iconClass = "bi bi-info-circle", string progressBarClass = "bg-info", int duration = 5000)
        {
